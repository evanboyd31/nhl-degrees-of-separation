import { type TeamPeriod } from "../types/nhl";

export const TEAM_COLORS: Record<string, TeamPeriod> = {
  // Anaheim Ducks
  ...
  "https://assets.nhle.com/logos/nhl/svg/ANA_20132014-20232024_light.svg": {
    fullName: "Anaheim Ducks",
    startYear: 2013,
    endYear: 2024,
    primaryColor: "#fc4c02",
  ...
  "https://assets.nhle.com/logos/nhl/svg/BOS_20082009-20222023_light.svg": {
    fullName: "Boston Bruins",
    startYear: 2008,
    endYear: 2023,
    primaryColor: "#ffb81c",
  ...
  "https://assets.nhle.com/logos/nhl/svg/BOS_20232024_light.svg": {
    fullName: "Boston Bruins",
    startYear: 2023,
    endYear: 2024,
    primaryColor: "#ffb81c",
  ...
  "https://assets.nhle.com/logos/nhl/svg/BOS_20242025-20242025_light.svg": {
    fullName: "Boston Bruins",
    startYear: 2024,
    endYear: 2025,
    primaryColor: "#ffb81c",
  ...
  "https://assets.nhle.com/logos/nhl/svg/BOS_light.svg?season=20252026": {
    fullName: "Boston Bruins",
    startYear: 2025,
    endYear: 2026,
    primaryColor: "#ffb81c",
